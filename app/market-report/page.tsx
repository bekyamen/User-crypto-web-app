                  ...
                  {filteredCryptos.slice(0, 50).map((coin) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-4">${parseFloat(coin.lastPrice).toFixed(4)}</td>
                        <td className={`py-4 font-semibold ${isUp ? "text-green-400" : "text-red-400"}`}>
                          {isUp ? "+" : ""}{change.toFixed(2)}%
                        </td>
                        <td className="py-4">${parseFloat(coin.highPrice).toFixed(4)}</td>
                        <td className="py-4">${parseFloat(coin.lowPrice).toFixed(4)}</td>
                        <td className="py-4">{parseFloat(coin.volume).toLocaleString()}</td>
                        <td className="py-4">
                          <button
